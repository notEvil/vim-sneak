...
func! sneak#mylabel(mode, reverse) abort
  let cnt = v:count1
  ...
  if sneak#label#mylabel(input, cnt, a:reverse)
    call s:attach_autocmds()
  endif
endf

nnoremap <silent> <Plug>MySneakLabel_s :<c-u>call sneak#mylabel('', 0)<cr>
nnoremap <silent> <Plug>MySneakLabel_S :<c-u>call sneak#mylabel('', 1)<cr>
xnoremap <silent> <Plug>MySneakLabel_s :<c-u>call sneak#mylabel(visualmode(), 0)<cr>
xnoremap <silent> <Plug>MySneakLabel_S :<c-u>call sneak#mylabel(visualmode(), 1)<cr>
onoremap <silent> <Plug>MySneakLabel_s :<c-u>call sneak#mylabel(v:operator, 0)<cr>
onoremap <silent> <Plug>MySneakLabel_S :<c-u>call sneak#mylabel(v:operator, 1)<cr>
